...
export const GitHubIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 .5a12 12 0 00-3.794 23.386c.6.111.82-.261.82-.58v-2.18c-3.338.726-4.043-1.416-4.043-1.416-.546-1.388-1.333-1.757-1.333-1.757-1.089-.745.083-.73.083-.73 1.204.085 1.838 1.236 1.838 1.236 1.07 1.835 2.807 1.305 3.49.998.108-.775.419-1.305.762-1.605-2.665-.304-5.467-1.333-5.467-5.93 0-1.31.468-2.381 1.236-3.221-.124-.303-.536-1.525.117-3.178 0 0 1.008-.322 3.3 1.23A11.5 11.5 0 0112 6.317a11.5 11.5 0 013.005.405c2.29-1.552 3.296-1.23 3.296-1.23.655 1.653.243 2.875.12 3.178.77.84 1.235 1.91 1.235 3.221 0 4.609-2.807 5.623-5.48 5.921.431.371.816 1.102.816 2.222v3.293c0 .322.216.696.825.578A12 12 0 0012 .5z"/></svg>
);

export const CopyIcon = (props) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
);

export const CheckIcon = (props) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}><polyline points="20 6 9 17 4 12"/></svg>
);

export const ArrowUpIcon = (props) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>
);

export const HuggingFaceIcon = (props) => (
